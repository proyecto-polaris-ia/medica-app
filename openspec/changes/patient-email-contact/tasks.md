...
|---|---|---|---|---|
| 1 | Resolver/migración / único PR | `npm run test -- src/lib/booking/__tests__/patient-resolution.test.ts` | `supabase db reset` y checks; sin runtime, estado UNAVAILABLE y decisión bloqueada | `0011_*`, `patient-resolution.ts` |
